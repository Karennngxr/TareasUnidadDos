    ...
    def mostrar_menu(self):
        while True:
            ...
            if opcion == "1":
                ...
                7nueva_materia = Materia(nombre=nombre_materia, descripcion=descripcion_materia, id_semestre=id_semestre, semestre=semestre_materia, creditos=creditos_materia)
